...
GetComponent.<Rigidbody>().AddTorque(transform.up * rnd, ForceMode.Impulse);
rnd=Random.Range(-impulseRot, impulseRot);
GetComponent.<Rigidbody>().AddTorque(transform.right * rnd, ForceMode.Impulse);
rnd=Random.Range(-impulseRot, impulseRot);
GetComponent.<Rigidbody>().AddTorque(transform.forward * rnd, ForceMode.Impulse);


GetComponent.<Rigidbody>().AddRelativeForce(Vector3(Random.Range(-impulseForce, impulseForce),Random.Range(-impulseForce, impulseForce), Random.Range(-impulseForce, impulseForce)), ForceMode.Impulse);
